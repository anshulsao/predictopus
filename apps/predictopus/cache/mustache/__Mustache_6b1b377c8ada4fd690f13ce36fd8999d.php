...
class __Mustache_6b1b377c8ada4fd690f13ce36fd8999d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE059c3f41208c9c5a642711577cf7ec7($context, $indent, $value);
    ...
    private function sectionE059c3f41208c9c5a642711577cf7ec7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
    ...
    <div class=\'col-md-12 text-mid pn-tools\'>
        <div class="btn-group pn-toolrow" data-toggle="buttons">
            <label class="btn btn-default col-md-4">
                <input type="radio" name=\'winner\' data-val=\'{{{team1Name}}}\' data-id=\'1\' {{#team1W}}checked{{/team1W}}>Win</label>
            <label class="btn btn-default col-md-4">
                <input type="radio" name=\'winner\' data-val=\'draw\' data-id=\'0\' {{#draw}}checked{{/draw}}>Draw</label>
            <label class="btn btn-default col-md-4">
                <input type="radio" name=\'winner\' data-val=\'{{{team2Name}}}\' data-id=\'2\' {{#team2W}}checked{{/team2W}}>Win</label>
        </div>      
