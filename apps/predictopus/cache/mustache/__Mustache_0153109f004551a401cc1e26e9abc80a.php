...
class __Mustache_0153109f004551a401cc1e26e9abc80a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section49515a6f4c99ea8d84e4a3c6b01e67f5($context, $indent, $value);
    ...
    private function section49515a6f4c99ea8d84e4a3c6b01e67f5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
<div class=\'bg-neg fnt-neg of-hid pd-15\'>
    ...
    <div class=\'col-md-12 text-mid\'>
        <button type="button" id=\'pn-submit\' class="btn btn-primary btn-sm" data-gameid="{{id}}">{{^p}}Save{{/p}}{{#p}}Edit{{/p}} Prediction</button>
