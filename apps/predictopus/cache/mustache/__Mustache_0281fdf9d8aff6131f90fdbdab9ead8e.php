...
class __Mustache_0281fdf9d8aff6131f90fdbdab9ead8e extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $indent . '            <li>
';
            $buffer .= $indent . '                <a href="" class="dropdown-toggle" data-toggle="dropdown">Sign out
';
...
';
        ...
        // 'loggedIn' section
        $value = $context->find('loggedIn');
        $buffer .= $this->sectionAac35efae4037016e108ad248b51181f($context, $indent, $value);
        $buffer .= $indent . '        </ul>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionAac35efae4037016e108ad248b51181f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="#" id=\'lgn-fb\'><b class="fb-icon-29px"></b>Facebook</a></li>
                    <!--li class="divider"></li>
