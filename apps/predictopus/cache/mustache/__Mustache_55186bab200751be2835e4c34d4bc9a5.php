...
class __Mustache_55186bab200751be2835e4c34d4bc9a5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section63179f300113eb713f8ad945d576727d($context, $indent, $value);
        $buffer .= $indent . '</ul>';
    ...
    private function sectionD4546e70cb65ee9d9f15d7cbb8209902(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                    <i class=\'flag flag-au\'></i>
';
                $buffer .= $indent . '                    <span>';
...
';
    ...
    private function section63179f300113eb713f8ad945d576727d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionD4546e70cb65ee9d9f15d7cbb8209902($context, $indent, $value);
                $buffer .= $indent . '        </ul>
';
                $buffer .= $indent . '
';
