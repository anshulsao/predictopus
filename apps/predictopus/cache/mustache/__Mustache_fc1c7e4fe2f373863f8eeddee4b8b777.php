...
class __Mustache_fc1c7e4fe2f373863f8eeddee4b8b777 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="btn-group pn-toolrow">
';
        $buffer .= $indent . '            <button type="button" class="btn btn-primary col-md-4">Win</button>
';
        $buffer .= $indent . '            <button type="button" class="btn btn-default col-md-4">Draw</button>
';
        $buffer .= $indent . '            <button type="button" class="btn btn-primary col-md-4">Win</button>
';
        $buffer .= $indent . '        </div>
