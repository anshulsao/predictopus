...
class __Mustache_2fd875d7be055c0e3e7638f0ff70fc73 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class=\'col-md-5 col-md-offset-2 text-mid pd-0\'>
';
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class=\'col-md-5 text-mid pd-0\'>
';
