...
class __Mustache_252a83859d83a0a44a1623ec32b3aaf3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section317d9ac18779e68bffb8261df6aa3856($context, $indent, $value);
        $buffer .= $indent . '    </ul>
';
        $buffer .= $indent . '</div>';
...
';
    ...
    private function section317d9ac18779e68bffb8261df6aa3856(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <li>
            <h4>{{title}} - {{dispDate}}</h4>
            <ul>
                {{#games}}
                <li>
                    <div>{{{team1Name}}} ({{team1Code}})</div>
...
';
                ...
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= ' - ';
                $value = $this->resolveValue($context->find('dispDate'), $context, $indent);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= '</h4>
';
                $buffer .= $indent . '            <ul>
