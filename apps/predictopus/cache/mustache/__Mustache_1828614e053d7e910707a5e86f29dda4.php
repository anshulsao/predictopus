...
class __Mustache_1828614e053d7e910707a5e86f29dda4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2240e1bfeb99eeb3ddb66685b6cd3188($context, $indent, $value);
        $buffer .= $indent . '</ul>';
    ...
    private function section332e0fb3765e42ff518eef7bff958c63(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <li class=\'fx-game\'>
                ...
                <div class=\'col-md-2 fx-actions\'>
                    <button type="button" class="btn btn-primary">Predict Now!</button>
                </div>
            </li>
            ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
...
';
                $buffer .= $indent . '                    <button type="button" class="btn btn-primary">Predict Now!</button>
';
                $buffer .= $indent . '                </div>
';
                $buffer .= $indent . '            </li>
';
    ...
    private function section2240e1bfeb99eeb3ddb66685b6cd3188(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section332e0fb3765e42ff518eef7bff958c63($context, $indent, $value);
                $buffer .= $indent . '        </ul>
';
                $buffer .= $indent . '
';
