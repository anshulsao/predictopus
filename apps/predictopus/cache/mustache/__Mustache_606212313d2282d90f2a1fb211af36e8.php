...
class __Mustache_606212313d2282d90f2a1fb211af36e8 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="btn-group btn-group-justified pn-toolrow">
';
        $buffer .= $indent . '            <div class="btn-group">
';
        $buffer .= $indent . '                <button type="button" class="btn btn-default">Win</button>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="btn-group">
';
        $buffer .= $indent . '                <button type="button" class="btn btn-default">Draw</button>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="btn-group">
...
';
        $buffer .= $indent . '            <input type="text" class="form-control" placeholder="Half time goals for Japan">
';
        $buffer .= $indent . '            <span class="input-group-addon">-</span>
';
        $buffer .= $indent . '            <input type="text" class="form-control" placeholder="Half time goals for Nigeria">
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div class="input-group pn-toolrow">
';
        $buffer .= $indent . '            <input type="text" class="form-control" placeholder="Full time goals for Japan">
';
        $buffer .= $indent . '            <span class="input-group-addon">-</span>
';
        $buffer .= $indent . '            <input type="text" class="form-control" placeholder="Full time goals for Japan">
