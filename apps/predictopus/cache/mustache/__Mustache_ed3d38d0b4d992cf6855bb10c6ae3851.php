...
class __Mustache_ed3d38d0b4d992cf6855bb10c6ae3851 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class=\'col-md-4 col-md-offset-4 text-mid pd-0\'>
';
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class=\'col-md-4 text-mid pd-0\'>
';
