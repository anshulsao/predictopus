...
class __Mustache_c2f8e6a9ecdc7c9e3b1b5893f1578742 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6c73d6d520dd96ee1c5c6d29f08f50b4($context, $indent, $value);

        return $buffer;
    }

    private function section0855b0b8dc427c153acfee1f947c991f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                $context->push($value);
                $buffer .= $indent . '        ';
                $value = $this->resolveValue($context->find('modified_date'), $context, $indent);
...
';
    ...
    private function section293901db132122340bc0066cb6b578e4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section0855b0b8dc427c153acfee1f947c991f($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function section6c73d6d520dd96ee1c5c6d29f08f50b4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section293901db132122340bc0066cb6b578e4($context, $indent, $value);
