...
class __Mustache_80862260e695ef1305d3fa15c7086585 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <li><a href="#">Sign out</a></li>
';
...
';
        $buffer .= $indent . '                    <li><a href="#"><b class="fb-icon-29px"></b>Facebook</a></li>
';
