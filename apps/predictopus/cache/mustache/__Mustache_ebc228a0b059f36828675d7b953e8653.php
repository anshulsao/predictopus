...
class __Mustache_ebc228a0b059f36828675d7b953e8653 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2887c8dd82c3089d238f91b9b3dfea8c($context, $indent, $value);

        return $buffer;
    }

    private function section2887c8dd82c3089d238f91b9b3dfea8c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
<h1 class=\'fx-title-gm pdh-15 bg mod-title\'>Predict results for Matchday 1 - {{date}}</h1>
...
';
            ...
            foreach ($values as $value) {
                $context->push($value);
                $buffer .= $indent . '<h1 class=\'fx-title-gm pdh-15 bg mod-title\'>Predict results for Matchday 1 - ';
