...
class __Mustache_c438a9362377a6570487b6fc4342552d extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <button type="button" class="btn btn-primary btn-sm">Predict Now!</button>
';
        $buffer .= $indent . '        <button type="button" class="btn btn-primary btn-default">Cancel</button>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>';
