...
class __Mustache_7134ba80b457fddcf1b53c682a560c6b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA3cbe66baaad5284475e65150c1db183($context, $indent, $value);
        $buffer .= $indent . '</ul>';
...
';
    ...
    private function sectionA3cbe66baaad5284475e65150c1db183(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
