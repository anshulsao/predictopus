...
class __Mustache_b97d039e8f3bf922dfca30a199447ac6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEbb13596b011ffcd1e3e0d95dad76e5c($context, $indent, $value);
    ...
    private function sectionEbb13596b011ffcd1e3e0d95dad76e5c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
    ...
    <div class=\'col-md-12 text-mid pn-tools\'>
        <div class="btn-group pn-toolrow" data-toggle="buttons">
            ...
            <label class="btn btn-default col-md-4 {{#p}}{{#draw}}active{{/draw}}{{/p}}">
                <input type="radio" name=\'winner\' data-val=\'\' data-id=\'0\' {{#p}}{{#draw}}checked{{/draw}}{{/p}}>Draw</label>
...
';
                ...
                $buffer .= '">
';
                $buffer .= $indent . '                <input type="radio" name=\'winner\' data-val=\'\' data-id=\'0\' ';
                // 'p' section
                $value = $context->find('p');
