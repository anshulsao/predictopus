...
class __Mustache_8c0de180ca22c88813eddf6febf03bcc extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAd380f3ff053fab7bdc613d0dfef4b92($context, $indent, $value);
...
';
    ...
    private function sectionAd380f3ff053fab7bdc613d0dfef4b92(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            ...
            <li>
                ...
                <ul class="dropdown-menu">
                    <li role="presentation" class="dropdown-header">Hi {{name}},</li>
                    <li class="divider"></li>
...
';
                $buffer .= $indent . '                <ul class="dropdown-menu">
';
                $buffer .= $indent . '                    <li role="presentation" class="dropdown-header">Hi ';
