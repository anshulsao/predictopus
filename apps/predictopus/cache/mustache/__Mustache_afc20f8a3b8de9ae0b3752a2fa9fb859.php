...
class __Mustache_afc20f8a3b8de9ae0b3752a2fa9fb859 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class=\'col-md-6 text-mid\'>
';
        $buffer .= $indent . '        <img class=\'pn-badge\' src=\'/assets/img/badges/132px-Japan_national_team.png\'>
';
        $buffer .= $indent . '        <h2 class=\'fnt-a1\'>Japan</h2>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class=\'col-md-6 text-mid\'>
';
        $buffer .= $indent . '        <div class=\'pn-versus fnt-a1\'>vs</div>
';
        $buffer .= $indent . '        <img class=\'pn-badge\' src=\'/assets/img/badges/140px-Nigeria_FA.svg.png\'>
';
        $buffer .= $indent . '        <h2 class=\'fnt-a1\'>Nigeria</h2>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>';
