...
class __Mustache_7d11fbcad8401db1bb039bf40f30e3e0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section61ffa3a534d8ef865acedb79d523ed87($context, $indent, $value);
        $buffer .= $indent . '    </ul>
';
        $buffer .= $indent . '</div>';
...
';
    ...
    private function section61ffa3a534d8ef865acedb79d523ed87(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
