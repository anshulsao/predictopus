...
class __Mustache_36dcd9f5e13fc8809325408e955756cd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section79ea22e90a32afbd430b125d98f07680($context, $indent, $value);

        return $buffer;
    }

    private function section79ea22e90a32afbd430b125d98f07680(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class=\'bg-neg fnt-neg of-hid pd-15\'>
    ...
    <div class=\'col-md-12 text-mid pn-tools\'>
        ...
        <div class="input-group pn-toolrow">
            <input id=\'hScore1\' type="number" class="form-control text-mid" min="0" max="15" placeholder="Half time goals for Japan">
            <span class="input-group-addon">-</span>
            <input id=\'hScore2\' type="number" class="form-control text-mid" min="0" max="15" placeholder="Half time goals for Nigeria">
        </div>
        <div class="input-group pn-toolrow">
            <input id=\'fScore1\' type="number" class="form-control text-mid" min="0" max="15" placeholder="Full time goals for Japan">
            <span class="input-group-addon">-</span>
            <input id=\'fScore2\' type="number" class="form-control text-mid" min="0" max="15" placeholder="Full time goals for Japan">
        </div>
    </div>
...
';
                $buffer .= $indent . '            <input id=\'hScore1\' type="number" class="form-control text-mid" min="0" max="15" placeholder="Half time goals for Japan">
';
                $buffer .= $indent . '            <span class="input-group-addon">-</span>
';
                $buffer .= $indent . '            <input id=\'hScore2\' type="number" class="form-control text-mid" min="0" max="15" placeholder="Half time goals for Nigeria">
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '        <div class="input-group pn-toolrow">
';
                $buffer .= $indent . '            <input id=\'fScore1\' type="number" class="form-control text-mid" min="0" max="15" placeholder="Full time goals for Japan">
';
                $buffer .= $indent . '            <span class="input-group-addon">-</span>
';
                $buffer .= $indent . '            <input id=\'fScore2\' type="number" class="form-control text-mid" min="0" max="15" placeholder="Full time goals for Japan">
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '    </div>
