...
class __Mustache_8a227dc4f062bb1f4c0899bf4937e487 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2b88ff82fd8ab3280e7447fc6d94b16e($context, $indent, $value);
        $buffer .= $indent . '</ul>';
    ...
    private function section4ec6de433e491532729f0ce72aab637a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <li class=\'fx-game\'>
                ...
                <div class=\'col-md-4 fx-venue\'>
                    <span>{{{groundFullTitle}}}</span>
                </div>
                <div class=\'col-md-2 fx-actions\'>
                    <button type="button" class="btn btn-primary btn-xs">Predict Now!</button>
                </div>
            </li>
            ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
...
';
                $buffer .= $indent . '                    <button type="button" class="btn btn-primary btn-xs">Predict Now!</button>
';
                $buffer .= $indent . '                </div>
';
                $buffer .= $indent . '            </li>
';
    ...
    private function section2b88ff82fd8ab3280e7447fc6d94b16e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section4ec6de433e491532729f0ce72aab637a($context, $indent, $value);
                $buffer .= $indent . '        </ul>
';
                $buffer .= $indent . '
';
