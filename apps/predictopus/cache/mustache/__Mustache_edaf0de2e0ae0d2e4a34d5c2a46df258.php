...
class __Mustache_edaf0de2e0ae0d2e4a34d5c2a46df258 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <label class="btn btn-primary">
';
        $buffer .= $indent . '                <input type="radio">Win</label>
';
        $buffer .= $indent . '            <label class="btn btn-default">
';
        $buffer .= $indent . '                <input type="radio">Draw</label>
';
        $buffer .= $indent . '            <label class="btn btn-primary">
';
        $buffer .= $indent . '                <input type="radio">Win</label>
