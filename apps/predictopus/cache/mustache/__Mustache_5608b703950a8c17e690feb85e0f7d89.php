...
class __Mustache_5608b703950a8c17e690feb85e0f7d89 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section82b2d8233269f83b4ce8e608f53daf60($context, $indent, $value);
        $buffer .= $indent . '</ul>';
...
';
    ...
    private function section82b2d8233269f83b4ce8e608f53daf60(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
